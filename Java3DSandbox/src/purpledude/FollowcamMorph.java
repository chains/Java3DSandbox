...
public class FollowcamMorph extends javax.media.j3d.Behavior {
     ...
     *@param moveMe The TransformGroup we are to move.
     *@param px A Picktool to find our height.
     *@param vista The transformGroup for the ViewingPlatform
     */  
    public FollowcamMorph(Alpha a, Morph m, TransformGroup moveMe, PickTool px, TransformGroup vista) 
    {
        picker = px;
	alpha = a;
	morph = m;
