 ...
 * ClimbDude.java
 *
 * Created on 21 April 2003, 18:34
 */
import java.awt.*;
 ...
 * @author  Ben Moxon
 */
public class ClimbDude extends java.applet.Applet  {
	...
	for(int i=0; i<3; i++) 
        ...
        try
        {
            ...
            objFiles[0] = new java.net.URL(filePath+"models/msFigureStep1.ms3d");
            objFiles[1] = new java.net.URL(filePath+"models/msFigureStanding.ms3d");
            objFiles[2] = new java.net.URL(filePath+"models/msFigureStep2.ms3d");
...
//    }
    ...
    {
	new MainFrame(new ClimbDude(), 700, 700);
    }
}
